...
from AutoML_data_manager import data_converter, data_io
from AutoML_data_manager.data_io import vprint
...
class DataManager:
	...
	def loadLabel (self, filename, verbose=True):
		...
		# IG: Here change to accommodate the averages multiclass label format
